local ghost_combinator_item = table.deepcopy(data.raw["item"]["constant-combinator"])
local ghost_combinator_entity = table.deepcopy(data.raw["constant-combinator"]["constant-combinator"])
